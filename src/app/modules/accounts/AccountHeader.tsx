          ...
          <div className='d-flex flex-wrap flex-sm-nowrap mb-3'>
            <div className='me-7 mb-4'>
              <div className='symbol symbol-100px symbol-lg-160px symbol-fixed position-relative'>
                <img src={toAbsoluteUrl(currentUser.avatar)} alt='Metronic' />
              ...
              <div className='d-flex justify-content-between align-items-start flex-wrap mb-2'>
                <div className='d-flex flex-column'>
                  <div className='d-flex align-items-center mb-2'>
                    ...
                    >
                      {' '}
                      {currentUser.isProfessional && currentUser.entityType == 'particular'
                        ? 'Particular'
                        : currentUser.isProfessional &&
                          currentUser.entityType == 'company' &&
                          'Compary'}
                    </a>
                  </div>
                  ...
                  <div className='d-flex flex-wrap'>
                    <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                      <div className='d-flex align-items-center'>
                        ...
                        <div className='fs-2 fw-bolder'>{currentUser.reviews} </div>
                      </div>
